...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="txtApellidos">Descripci&oacute;n: </label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="txtstockmaximo" name="txtstockmaximo" type="number" placeholder="Stock m&aacute;ximo del productos" class="form-control input-md" required="">
  </div>
</div>
<div class="form-group">
